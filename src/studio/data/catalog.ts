...
const RAW_ITEMS: RawCatalogEntry[] = [
  {
    ...
    contentsLine: '4 bites (10 g each) arranged around your 120 × 60 mm, 50 g message bar.',
  ...
  },
  {
    ...
    contentsLine: '9 bites (10 g each) + an 85 × 85 mm, 60 g square bar on top, in a two-tier tin.',
  ...
  },
  {
    ...
    contentsLine: '16 bites (10 g each) + your 85 × 85 mm, 60 g message bar.',
  ...
  },
  {
    ...
    contentsLine: '18 bites (10 g each), stacked two tiers deep in an 11 × 11 cm tin.',
  ...
  },
  {
    ...
    contentsLine: '3 bites (10 g each) in a row, in a gold window tray.',
    occasions: ['corporate', 'birthday'],
    product: 'bite',
    packagingType: 'box-3',
    section: 'classic',
  ...
  // one-block re-add when ready.
  {
    ...
    photo: '/studio/card-9.webp',
    wrappedPhoto: '/studio/card-9-wrapped.webp',
    contentsLine: '9 bites (10 g each), three rows of three, in an 11 × 11 cm box.',
    occasions: ['eid'],
    product: 'bite',
    packagingType: 'box-9',
    section: 'classic',
  },
  {
    ...
    contentsLine: '12 bites (10 g each), laid flat in a 16 × 20 cm box.',
  ...
  },
  {
    ...
    contentsLine: '15 bites (10 g each), five across and three deep, in a rectangular purple tin.',
  ...
  },
  {
    ...
    contentsLine: '25 bites (10 g each), five rows of five, in a 20 × 20 cm tin.',
  ...
  },
  {
    ...
    photo: '/studio/card-25.webp',
    wrappedPhoto: '/studio/card-25-wrapped.webp',
    contentsLine: '50 bites (10 g each), stacked two tiers deep, in a 20 × 20 cm tin.',
    occasions: ['corporate', 'wedding'],
    product: 'bite',
  ...
  },
  {
    ...
    contentsLine: '30 × 30 mm bites (10 g each), foil-wrapped and packed loose — ready for your own presentation.',
    occasions: ['corporate', 'birthday'],
    product: 'bite',
  ...
  },
  {
    ...
    wrappedPhoto: '/studio/foil-bite-gold.webp',
    contentsLine: 'One 45 × 45 mm, 25 g Signature piece, foil-wrapped and packed loose.',
  ...
  },
  {
    ...
    contentsLine: 'One 120 × 60 mm, 50 g bar, foil-wrapped.',
    occasions: ['corporate'],
    product: 'bar',
    packagingType: 'individual',
    section: 'loose',
  },
  {
    ...
    contentsLine: 'One 90 × 30 mm, 25 g slim bar, foil-wrapped.',
    occasions: ['corporate'],
    product: 'slim',
    packagingType: 'individual',
    section: 'loose',
