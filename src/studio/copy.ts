...
export const CUSTOM_BRIEF_COPY = {
  ...
  thicknessHint: 'Thickness sets the piece weight — most of our pieces run 8–12 mm.',
  sizeError: `That won't fit our largest mold — a piece must fit within A4 (about ${maxMoldSizeCm}).`,
  chocolateLabel: 'Chocolate',
  wrapLabel: 'Wrapping',
  wrapNone: 'Unwrapped',
  wrapFoil: 'Foil-wrapped',
  wrapPrinted: 'Printed wrapper',
  ...
  ctaLockedNote: 'Pick a shape and fill in width, height, and thickness to send your brief.',
